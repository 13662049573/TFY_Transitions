//
//  TFY_PercentDrivenInteractiveTransition.m
//  TFY_Transitions
//
...
@interface TFY_PercentDrivenInteractiveTransition ()
...
@implementation TFY_PercentDrivenInteractiveTransition
...
- (CGFloat)percentForGesture:(UIPanGestureRecognizer *)gesture
{
    ...
    if ([gesture isMemberOfClass: [UIScreenEdgePanGestureRecognizer class]] ||
        [gesture isMemberOfClass: NSClassFromString(@"TFY_ScreenEdgePanGestureRecognizer")])
    {

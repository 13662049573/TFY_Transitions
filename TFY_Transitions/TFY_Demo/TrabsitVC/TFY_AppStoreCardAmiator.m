...
@implementation TFY_AppStoreCardAmiator
{
...
- (void)animateTransition:(nonnull id<UIViewControllerContextTransitioning>)transitionContext {
    NSAssert(!self.isPushOrPop, @"TFY_AppStoreCardAmiator only support present transition");
    if(CGRectEqualToRect(self.fromRect, CGRectNull) || CGRectEqualToRect(self.fromRect, CGRectZero)) {
        NSAssert(NO, @"TFY_AppStoreCardAmiator 类型必须初始化 fromRect");
    }

//
//  TFY_AppStoreDetialController.m
//  TFY_Transitions
//
...
@interface TFY_AppStoreDetialController ()<UIScrollViewDelegate>
@property(nonatomic, strong) UIScrollView *scrollView;

@property(nonatomic, assign) BOOL allowDismiss;
@end

@implementation TFY_AppStoreDetialController
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (_allowDismiss && scrollView.contentOffset.y < 0) {
        _allowDismiss = NO;
        self.transitionDelegate.tempInteractiveDirection = DirectionToBottom;
